...
const EXPECTED = {
  ...
  NAV:7, THEMES:8, ROLE_LEVELS:4, PERM_KEYS:3,
  ...
  /* the loads module */
  LOADS_SECTIONS:5, LOADS:62, COLLECTIONS:9, ORDERS:12, TRUCKS:12, DRIVERS:12,
  BELL_SHEETS:26, DISPATCH_AGENDA:8, STANDING_ORDERS:6
};
